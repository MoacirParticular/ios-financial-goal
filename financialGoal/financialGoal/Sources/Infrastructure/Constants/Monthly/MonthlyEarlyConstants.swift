...
struct InfoCalcScreen {
    static let monthly: CalcScreenData = CalcScreenData(.Monthly, "Período em meses", "Taxa de juros mensal", "Valor da aplicação inicial", "Valor da aplicação mensal", "Valor obtido no final", "CALCULAR")
